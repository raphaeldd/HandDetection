...
# Generated by qmake (2.01a) (Qt 4.8.5) on: wo mrt. 19 15:07:12 2014
...
CC            = /usr/bin/gcc-4.2
CXX           = /usr/bin/g++-4.2
DEFINES       = -DUSE_FFTW -DQT_NO_DEBUG -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O2 -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -fopenmp -ggdb -Wall -W $(DEFINES)
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HandDetection1.0.0/ && $(COPY_FILE) --parents Mixture.h JPEGImage.h Model.h HOGPyramid.h Patchwork.h Rectangle.h SimpleOpt.h Scene.h Intersector.h Object.h PersonDetection.h Parameters.h DetBody.h DetHand.h SaveDetections.h HighestLikelihood.h Tracking.h .tmp/HandDetection1.0.0/ && $(COPY_FILE) --parents Mixture.cpp JPEGImage.cpp Model.cpp HOGPyramid.cpp Patchwork.cpp Rectangle.cpp Scene.cpp Object.cpp PersonDetection.cpp main.cpp DetBody.cpp DetHand.cpp SaveDetections.cpp HighestLikelihood.cpp Tracking.cpp .tmp/HandDetection1.0.0/ && (cd `dirname .tmp/HandDetection1.0.0` && $(TAR) HandDetection1.0.0.tar HandDetection1.0.0 && $(COMPRESS) HandDetection1.0.0.tar) && $(MOVE) `dirname .tmp/HandDetection1.0.0`/HandDetection1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HandDetection1.0.0
