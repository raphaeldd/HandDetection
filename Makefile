...
# Generated by qmake (2.01a) (Qt 4.8.5) on: do feb. 13 16:36:26 2014
...
CXXFLAGS      = -pipe -fopenmp -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.6 -Wall -W $(DEFINES)
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HandDetection1.0.0/ && $(COPY_FILE) --parents Mixture.h JPEGImage.h Model.h HOGPyramid.h Patchwork.h Rectangle.h SimpleOpt.h Scene.h Intersector.h Object.h PersonDetection.h Parameters.h DetBody.h DetHand.h SaveDetections.h .tmp/HandDetection1.0.0/ && $(COPY_FILE) --parents Mixture.cpp JPEGImage.cpp Model.cpp HOGPyramid.cpp Patchwork.cpp Rectangle.cpp Scene.cpp Object.cpp PersonDetection.cpp main.cpp DetBody.cpp DetHand.cpp SaveDetections.cpp .tmp/HandDetection1.0.0/ && (cd `dirname .tmp/HandDetection1.0.0` && $(TAR) HandDetection1.0.0.tar HandDetection1.0.0 && $(COMPRESS) HandDetection1.0.0.tar) && $(MOVE) `dirname .tmp/HandDetection1.0.0`/HandDetection1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HandDetection1.0.0
